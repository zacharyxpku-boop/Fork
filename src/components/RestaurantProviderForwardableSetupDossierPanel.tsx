  ...
  return (
    <div className="mt-3 border border-violet-200/15 bg-violet-200/[0.035] p-3">
      <div className="flex flex-col gap-2 lg:flex-row lg:items-start lg:justify-between">
        <div>
          <div className="text-[10px] font-semibold uppercase tracking-[0.14em] text-violet-100/65">forwardable setup dossier</div>
          <p className="mt-1 text-xs font-black text-white">One packet each for Provider engineer, merchant owner, data owner and store ops lead.</p>
          <p className="mt-1 text-[11px] leading-4 text-violet-100/55">contract: {dossier?.firstLiveRunContract.launchVerdict || 'blocked-before-launch'} / callback {dossier?.firstLiveRunContract.callbackHeader || 'x-restaurant-agent-signature'}</p>
        </div>
        <div className="border border-white/10 bg-stone-950/45 px-3 py-2 text-right">
          <div className="text-[10px] font-semibold uppercase tracking-[0.14em] text-white/40">live provider</div>
      ...
      <div className="mt-3 grid gap-2 md:grid-cols-6">
        <div className="border border-white/10 bg-stone-950/45 p-2">
          <div className="text-[10px] font-semibold uppercase tracking-[0.14em] text-white/40">packets</div>
        ...
        <div className="border border-white/10 bg-stone-950/45 p-2">
          <div className="text-[10px] font-semibold uppercase tracking-[0.14em] text-white/40">env</div>
